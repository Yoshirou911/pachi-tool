...
_MACHINE_NAME_ALIASES: dict[str, str] = {
    ...
    "鬼武者":                           "スマスロ鬼武者",
    "スマスロ 鬼武者":                  "スマスロ鬼武者",
    "Re:ゼロ":                          "スマスロReゼロから始める異世界生活",
    "リゼロ":                           "スマスロReゼロから始める異世界生活",
    "スマスロリゼロ":                    "スマスロReゼロから始める異世界生活",
    "Reゼロ":                           "スマスロReゼロから始める異世界生活",
    "スマスロRe:ゼロから始める異世界生活": "スマスロReゼロから始める異世界生活",
    # DB名のゆれ → JSON対応
    "バジリスク～甲賀忍法帖～絆2 天膳 BLACK EDITION": "スマスロバジリスク絆3",
    "バジリスク絆2天膳":                "スマスロバジリスク絆3",
    "バジリスク絆2 天膳":              "スマスロバジリスク絆3",
    "モンキーターンV":                  "スマスロ モンキーターン5",
    "スマスロモンキーターン5":           "スマスロ モンキーターン5",
    "バーサスリヴァイズ":               "バーサスライジング",
    "ソードアート・オンラインII":        "ソードアート・オンライン II",
    "ニューキングハナハナV‐30":         "ニューキングハナハナV-30",
    "マイジャグラーV":                  "マイジャグラー5",
    "アイムジャグラーEX-TP":            "アイムジャグラーEX Anniversary",
    "スマスロ炎炎ノ消防隊2":            "スマスロ炎炎ノ消防隊2",
    "炎炎ノ消防隊2":                    "スマスロ炎炎ノ消防隊2",
    "北斗の拳 転生の章2":              "スマスロ北斗の拳 転生の章2",
    "北斗転生の章2":                   "スマスロ北斗の拳 転生の章2",
    "無職転生":                         "スマスロ転生したらスライムだった件",
    "化物語":                           "スマスロ化物語",
    "新鬼武者3":                        "スマスロ鬼武者",
    "攻殻機動隊":                       "スマスロ攻殻機動隊",
    "不二子BT":                         "スマスロ不二子BT",
    "かぐや様は告らせたい":              "スマスロかぐや様は告らせたい",
    "東京喰種":                          "スマスロ東京喰種",
    "聖闘士星矢 海皇覚醒 CUSTOM EDITION": "スマスロ聖闘士星矢",
    "革命機ヴァルヴレイヴ2":            "スマスロヴァルヴレイヴ2",
    "戦国乙女5 業火を穿つ宿焔の双刃":   "スマスロ戦国乙女5",
    "沖ドキ!BLACK":                     "沖ドキ！BLACK",
    "沖ドキ!DUO アンコール":            "沖ドキ！DUO",
    "沖ドキ!GOLD‐30":                   "沖ドキ！GOLD-30",
    "スマスロ転生したらスライムだった件": "スマスロ転生したらスライムだった件",
    "スマスロ蒼天の拳":                  "スマスロ蒼天の拳",
    "スマスロ犬夜叉":                    "スマスロ犬夜叉",
    "スマスロ進撃の巨人":               "スマスロ進撃の巨人",
    "大海物語5":                        "スマスロ大海物語5",
    ...
    # 番長/吉宗/虚構推理/ガンダムユニコーン
    "いざ！番長":                       "スマスロいざ！番長",
    "番長4":                            "スマスロいざ！番長",
    "吉宗":                             "スマスロ吉宗",
    "真打 吉宗":                        "スマスロ吉宗",
    "虚構推理":                         "スマスロ虚構推理",
    "ガンダムユニコーン":               "スマスロ機動戦士ガンダムユニコーン",
    "機動戦士ガンダムユニコーン":        "スマスロ機動戦士ガンダムユニコーン",
    "北斗の拳 転生の章2":              "スマスロ北斗の拳 転生の章2",
    "スマスロ モンキーターン5":          "スマスロ モンキーターン5",
}
